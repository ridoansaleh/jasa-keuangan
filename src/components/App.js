    ...
    return (
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div
            className="box"
            style={this.state.show === 1 ? greenBorder : greyBorder}
            onClick={(e) => this.changeProductDetail(e, 1)}
          >
            <div>
            ...
            <p className="box-content">
              Mitra Penyedia Pinjaman Merchant Tokopedia
            </p>
            <p
              className="box-detail"
              style={this.state.show === 1 ? greenColor : greyColor}
            >
              Lihat Detail Produk
            </p>
          </div>
          <div
            className="box"
            style={this.state.show === 2 ? greenBorder : greyBorder}
            onClick={(e) => this.changeProductDetail(e, 2)}
          >
            <div>
            ...
            <p className="box-content">
              Ajukan Kartu Kredit yang sesuai dengan kebutuhan
            </p>
            <p
              className="box-detail"
              style={this.state.show === 2 ? greenColor : greyColor}
            >
              Lihat Detail Produk
            </p>
          </div>
          <div
            className="box"
            style={this.state.show === 3 ? greenBorder : greyBorder}
            onClick={(e) => this.changeProductDetail(e, 3)}
          >
            <div>
            ...
            <p className="box-content">
              Ajukan Pinjaman tanpa Agunan yang Sesuai
            </p>
            <p
              className="box-detail"
              style={this.state.show === 3 ? greenColor : greyColor}
            >
              Lihat Detail Produk
            </p>
          </div>
          <div
            className="box"
            style={this.state.show === 4 ? greenBorder : greyBorder}
            onClick={(e) => this.changeProductDetail(e, 4)}
          >
            <div>
            ...
            <p className="box-content">
              Ajukan Asuransi yang sesuai dengan kebutuhan
            </p>
            <p
              className="box-detail"
              style={this.state.show === 4 ? greenColor : greyColor}
            >
              Lihat Detail Produk
            </p>
          </div>
